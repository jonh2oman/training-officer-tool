...
class LessonLibrary {
  static final List<Lesson> allLessons = [
    ...
    Lesson(code: 'MX20.01', title: 'Participate in a CAF Engagement Activity', phase: Phase.phase1, periods: 9, isMandatory: true),

    // Phase 1 Fundamental (Complementary)
    Lesson(code: 'CX01.01', title: 'Participate in Citizenship Activities', phase: Phase.phase1, periods: 18),
    Lesson(code: 'CX02.01', title: 'Perform Community Service', phase: Phase.phase1, periods: 18),
    ...
    Lesson(code: 'CX04.01', title: 'Participate in the CFA and Identify Strategies', phase: Phase.phase1, periods: 3),
    Lesson(code: 'CX04.02', title: 'Participate in Activities for Physical Fitness', phase: Phase.phase1, periods: 3),
    Lesson(code: 'CX04.03', title: 'Participate in a Cooking Class', phase: Phase.phase1, periods: 3),
    Lesson(code: 'CX04.04', title: 'Attend a Healthy Living Presentation', phase: Phase.phase1, periods: 3),
    Lesson(code: 'CX04.05', title: 'Attend a Local Amateur Sporting Event', phase: Phase.phase1, periods: 3),
    Lesson(code: 'CX05.01', title: 'Participate in Physical Activities', phase: Phase.phase1, periods: 9),
    Lesson(code: 'CX05.02', title: 'Participate in a Tournament', phase: Phase.phase1, periods: 9),
    ...
    Lesson(code: 'CX20.01', title: 'Participate in CAF Familiarization Activities', phase: Phase.phase1, periods: 18),
    ...
    Lesson(code: 'MX20.01', title: 'Participate in a CAF Engagement Activity', phase: Phase.phase2, periods: 9, isMandatory: true),
    ...
    Lesson(code: 'MX01.01C', title: 'Participate in Citizenship Activities', phase: Phase.phase3, periods: 3, isMandatory: true),
    ...
    Lesson(code: 'MX04.01', title: 'Participate in 60 Minutes of MVPA', phase: Phase.phase3, periods: 3, isMandatory: true),
    ...
    Lesson(code: 'MX20.01', title: 'Participate in a CAF Engagement Activity', phase: Phase.phase3, periods: 9, isMandatory: true),
    ...
    Lesson(code: 'MX20.01', title: 'Participate in a CAF Engagement Activity', phase: Phase.phase4, periods: 9, isMandatory: true),
    ...
    ...Phase.values.expand((p) => [
      Lesson(code: 'OPT-DRILL', title: 'Drill Team Practice', phase: p, periods: 20, category: 'Optional'),
      Lesson(code: 'OPT-MUSIC', title: 'Music Practice', phase: p, periods: 20, category: 'Optional'),
      Lesson(code: 'OPT-MARK', title: 'Marksmanship Practice', phase: p, periods: 20, category: 'Optional'),
      Lesson(code: 'OPT-BIAT', title: 'Biathlon Practice', phase: p, periods: 10, category: 'Optional'),
      Lesson(code: 'OPT-ORIENT', title: 'Orienteering Practice', phase: p, periods: 10, category: 'Optional'),
      Lesson(code: 'OPT-BOAT', title: 'Model Boat Club', phase: p, periods: 10, category: 'Optional'),
      Lesson(code: 'OPT-SEAM', title: 'Seamanship Team Practice', phase: p, periods: 20, category: 'Optional'),
      Lesson(code: 'EVT-HALW', title: 'Hallowe\'en Costume Dance', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-POPPY', title: 'Poppy Campaign', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-REMB', title: 'Remembrance Day Visit', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-XMAS', title: 'Christmas Mess Dinner', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-CAROL', title: 'Caroling at Veterans\' Home', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-SANTA', title: 'Santa Claus Parade', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-TREAS', title: 'Treasure Hunt Day', phase: p, periods: 1, category: 'Optional'),
      Lesson(code: 'EVT-ANML', title: 'Volunteering at Animal Shelter', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-SWIM', title: 'Swimming night', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-PIRAT', title: 'Pirate Sports Day', phase: p, periods: 1, category: 'Optional'),
      Lesson(code: 'EVT-VALNT', title: 'Valentine\'s Skating Party', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-YOGA', title: 'Yoga day', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-MOVIE', title: 'Movie night', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-GEOC', title: 'Geocaching', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-RELAY', title: 'Charity Relay', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-MUSE', title: 'Maritime Museum Tour', phase: p, periods: 3, category: 'Optional'),
      Lesson(code: 'EVT-BARBQ', title: 'End-of-Year Barbecue', phase: p, periods: 3, category: 'Optional'),
    ]),
  ];
